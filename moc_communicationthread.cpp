...
QT_MOC_LITERAL(1, 20, 15), // "receivedMessage"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 7) // "message"

    },
    "CommunicationThread\0receivedMessage\0"
    "\0message"
};
...
void CommunicationThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->receivedMessage((*reinterpret_cast< QJsonObject(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (CommunicationThread::*_t)(QJsonObject );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CommunicationThread::receivedMessage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CommunicationThread::receivedMessage(QJsonObject _t1)
{
